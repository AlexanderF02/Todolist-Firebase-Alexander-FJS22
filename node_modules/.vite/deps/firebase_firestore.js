...
var ao = class {
  ...
  getDocumentsMatchingQuery(t2, e, n, s) {
    ...
    return _o(t2).W(IDBKeyRange.bound(r, o, true)).next((t3) => {
      let n2 = ds();
      for (const i2 of t3) {
        const t4 = this.jn(ct.fromSegments(i2.prefixPath.concat(i2.collectionGroup, i2.documentId)), i2);
        t4.isFoundDocument() && (An(e, t4) || s.has(t4.key)) && // Either the document matches the given query, or it is mutated.
...
var lo = class extends co {
  ...
  getAllFromCache(t2, e) {
    return this.Yn.Hn(t2, e).next(({ documents: t3, Jn: e2 }) => (
...
var Bo = class {
   ...
   */
  Bi(t2, e, n, s) {
    return this.Ni.getDocumentsMatchingQuery(t2, n, s).next((t3) => (
...
!function(t2, e = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(b, "3.8.3", t2), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
  registerVersion(b, "3.8.3", "esm2017");
}();
export {
